...
if __name__ == '__main__':
    ...
    # 时间窗口
    # '''
    # time_windows_data = pd.read_csv('timeWindows.csv', header=0, encoding='gbk')
    ...
    # 数据读取
    # '''
    # allData = pd.read_csv('A_trans.csv', header=0, encoding='gbk')
    ...
    #
    # allData.to_csv('allData_makeup_missing.csv', header=True, encoding='gbk', columns=allData.columns, index=False)

    """
    变量分组 计算WOE IV
    """
    # trainData = pd.read_csv('allData_1_bak.csv', header=0, encoding='gbk')
    ...
    # encoded_var_dict = {}
    # merged_var_dict = {}
    # var_iv_dict = {}  # save the IV values for binned features
    # var_woe_dict = {}
    #
    ...
    # var_woe_file = open('var_woe_dict.pkl', 'wb')
    # pickle.dump(var_woe_dict, var_woe_file)
    # var_woe_file.close()
    #
    # var_iv_file = open('var_iv_dict.pkl', 'wb')
    # pickle.dump(var_iv_dict, var_iv_file)
    # var_iv_file.close()
    #
    # var_cutoff_file = open('var_cutoff_dict.pkl', 'wb')
    # pickle.dump(var_cutoff_dict, var_cutoff_file)
    # var_cutoff_file.close()
    #
    # var_merged_file = open('merged_var_dict.pkl', 'wb')
    ...
    with open('var_woe_dict.pkl', 'rb') as f:
        var_woe_dict = pickle.load(f, encoding='gbk')

    with open('var_iv_dict.pkl', 'rb') as f:
        var_iv_dict = pickle.load(f, encoding='gbk')

    with open('var_cutoff_dict.pkl', 'rb') as f:
        var_cutoff_dict = pickle.load(f, encoding='gbk')

    with open('merged_var_dict.pkl', 'rb') as f:
